...
const todoFactoryFns = (() => {
  ...
  const getDueDateShorthand = (task) => {
    ...
    if (difference < -0.9) {
      ...
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(unparsedDate, 'EEEE')
    } else {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(unparsedDate, 'MMM d')
    }
  };
